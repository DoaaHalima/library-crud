        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8"><h2>all <b>books</b></h2></div>
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <td><?php echo $book['coby_number'];?></td>
                        <td><?php echo $book['book_price'];?></td>
                        <td><?php echo $book['auther_id'];?></td>
                        <td><?php echo $book['publisher_id'];?></td>
                        <td>
                            <a href="selectbook.php?bookid=<?php echo $book['book_id'];?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                        </td>
                        <td>
